...
st.markdown("""<div class="tg-kicker">EMERGENT SYSTEMS LAB / TERRARIUM 01</div><div class="tg-title">Tiny Gods</div><div class="tg-sub">A living civilization terrarium where history becomes culture and exceptional lives become gods. Descend into villages, inspect their people, buildings, stories, rituals and trade, then climb back out to watch the whole world remember itself.</div><div style="margin-top:10px"><span class="tg-pill">CLICK VILLAGE → ENTER</span><span class="tg-pill">MYTHIC FIGURES = REAL AGENTS</span><span class="tg-pill">ESC = RETURN</span><span class="tg-pill">SPACE = PAUSE</span></div>""",unsafe_allow_html=True)
html=(ROOT/"terrarium.html").read_text(encoding="utf-8").replace("__TINY_GODS_CONFIG__",json.dumps(config))
patches=["culture_v03.js","spectacle_v04.js","ages_v05.js","legends_v05.js","dynasties_v06.js","card_compat_v08.js","under_glass_v07.js","under_glass_entry_fix_v08.js","identity_v07.js","archaeology_v07.js","construction_v07.js","daily_life_v07.js","role_effects_v07.js","house_life_v07.js","rituals_v07.js","memory_myth_v08.js","myth_transmission_v08.js","pantheon_v09.js","atmosphere_v09.js","overdrive_v09.js"]
...
with st.expander("What is actually happening under the glass?"):
 st.markdown("""Tiny Gods is still one live toy agent simulation underneath. The spectacle is derived from that state: settlements inherit culture and architecture; roads reflect relationships; houses reflect legendary ancestry; close-view roles feed weakly back into simulation outcomes; stories drift through kinship and trade; and the pantheon is composed of unusually consequential living agents. The Overdrive layer adds miniature world-map villages, smoke and firelight, village districts, inspectable People/Buildings/Stories/Rituals/Trade panels, and cultural claims about divine acts that preserve a quieter historical explanation underneath.""")
st.caption("Self-contained Streamlit showcase · procedural Canvas visuals · no external assets, accounts, API keys or tracking required.")