...
st.markdown("""<div class="tg-kicker">EMERGENT SYSTEMS LAB / TERRARIUM 01</div><div class="tg-title">Tiny Gods</div><div class="tg-sub">A living browser terrarium where agents become families, camps become cultures, legends become houses — and settlements now visibly construct, upgrade, weather, and preserve the layers of their own history.</div><div style="margin-top:10px"><span class="tg-pill">DOUBLE-CLICK CAMP = ENTER</span><span class="tg-pill">ESC = RETURN</span><span class="tg-pill">DRAG TO PAN</span><span class="tg-pill">WHEEL TO ZOOM</span><span class="tg-pill">SPACE = PAUSE</span></div>""",unsafe_allow_html=True)
html=(ROOT/"terrarium.html").read_text(encoding="utf-8").replace("__TINY_GODS_CONFIG__",json.dumps(config))
patches=["culture_v03.js","spectacle_v04.js","ages_v05.js","legends_v05.js","dynasties_v06.js","under_glass_v07.js","identity_v07.js","archaeology_v07.js","construction_v07.js"]
...
The close view now turns simulation state into visible development. Culture shapes civic form, prosperity changes detail, old buildings weather and leave ruins, prominent houses create compounds, and population growth can trigger visible construction projects. New huts rise through scaffolding instead of simply appearing, while civic centers visibly upgrade when a settlement crosses into a higher prosperity tier. Later development can also surround older monuments and civic spaces, making the settlement read as layered historical fabric rather than a reset scene.

The close view is not a separate canned village. It is another representation of the same simulation state.
