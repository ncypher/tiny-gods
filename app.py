...
st.markdown("""<div class="tg-kicker">EMERGENT SYSTEMS LAB / TERRARIUM 01</div><div class="tg-title">Tiny Gods</div><div class="tg-sub">A living browser terrarium where agents become families, camps become cultures, legends become houses — and close-view settlements now visibly build, trade, teach, tend hearths and move through daily routines.</div><div style="margin-top:10px"><span class="tg-pill">DOUBLE-CLICK CAMP = ENTER</span><span class="tg-pill">CLICK RESIDENT = INSPECT</span><span class="tg-pill">ESC = RETURN</span><span class="tg-pill">SPACE = PAUSE</span></div>""",unsafe_allow_html=True)
html=(ROOT/"terrarium.html").read_text(encoding="utf-8").replace("__TINY_GODS_CONFIG__",json.dumps(config))
patches=["culture_v03.js","spectacle_v04.js","ages_v05.js","legends_v05.js","dynasties_v06.js","under_glass_v07.js","identity_v07.js","archaeology_v07.js","construction_v07.js","daily_life_v07.js"]
...
Ages & Legends preserves unusually consequential lives. Dynasties & Echoes lets some of that history persist weakly through descendants. **Under the Glass** adds a second camera mode: double-click an active settlement and the world is re-rendered as an intimate 2.5D scene derived from that settlement's live population, culture, houses, monument, founder, stores and current world time.

The close view now carries both architectural and social history. Culture shapes civic form, prosperity changes detail, old buildings weather and leave ruins, houses establish compounds, population growth triggers visible construction, and civic centers upgrade in place. Residents also take context-sensitive daily-life roles: builders gather around active projects, traders gravitate toward caravan arrivals and market space, communal keepers tend the hearth, travelers favor the road and settlement edge, and knowledgeable agents can act as teachers near civic gathering spaces.

These roles are lightweight interpretations of existing traits and settlement state rather than a separate scripted economy. The goal is to make the simulation legible through movement and place.
