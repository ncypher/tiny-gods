...
st.markdown("""<div class="tg-kicker">EMERGENT SYSTEMS LAB / TERRARIUM 01</div><div class="tg-title">Tiny Gods</div><div class="tg-sub">A living browser terrarium where agents become families, camps become cultures, legends become houses — and the daily life you see in the streets now feeds gently back into construction, trade, knowledge and diplomacy.</div><div style="margin-top:10px"><span class="tg-pill">DOUBLE-CLICK CAMP = ENTER</span><span class="tg-pill">ESC = RETURN</span><span class="tg-pill">DRAG TO PAN</span><span class="tg-pill">WHEEL TO ZOOM</span><span class="tg-pill">SPACE = PAUSE</span></div>""",unsafe_allow_html=True)
html=(ROOT/"terrarium.html").read_text(encoding="utf-8").replace("__TINY_GODS_CONFIG__",json.dumps(config))
patches=["culture_v03.js","spectacle_v04.js","ages_v05.js","legends_v05.js","dynasties_v06.js","under_glass_v07.js","identity_v07.js","archaeology_v07.js","construction_v07.js","daily_life_v07.js","role_effects_v07.js"]
...
The close view now goes beyond representation. Residents occupy small roles based on their traits and current settlement conditions, and those roles have deliberately weak simulation consequences: builders can slightly accelerate projects, traders improve exchange efficiency, hearth-keepers gently reinforce communal stability, teachers can spread knowledge, and travelers can improve contact with nearby non-hostile settlements.

The effect is intentionally modest. Street-level life should matter without turning the village view into a deterministic control panel.
