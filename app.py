...
st.markdown("""<div class="tg-kicker">EMERGENT SYSTEMS LAB / TERRARIUM 01</div><div class="tg-title">Tiny Gods</div><div class="tg-sub">Under-the-Glass stabilization build: the full v0.7 civilization stack plus reinforced settlement entry controls. Memory & Myth is temporarily isolated while its parser issue is repaired.</div><div style="margin-top:10px"><span class="tg-pill">CLICK CAMP → ENTER SETTLEMENT</span><span class="tg-pill">DOUBLE-CLICK CAMP = ENTER</span><span class="tg-pill">ESC = RETURN</span><span class="tg-pill">SPACE = PAUSE</span></div>""",unsafe_allow_html=True)
html=(ROOT/"terrarium.html").read_text(encoding="utf-8").replace("__TINY_GODS_CONFIG__",json.dumps(config))
patches=["culture_v03.js","spectacle_v04.js","ages_v05.js","legends_v05.js","dynasties_v06.js","under_glass_v07.js","under_glass_entry_fix_v08.js","identity_v07.js","archaeology_v07.js","construction_v07.js","daily_life_v07.js","role_effects_v07.js","house_life_v07.js","rituals_v07.js"]
...
with st.expander("What is actually happening under the glass?"):
    st.markdown("""This diagnostic build keeps the complete stable v0.7 simulation and close-view stack while isolating the new v0.8 mythology scripts. Double-click an active settlement, or click it and use **ENTER SETTLEMENT**, to descend into the 2.5D settlement view. If this build loads cleanly, the remaining parser problem is confined to the new Memory & Myth layer rather than Under the Glass.""")
