...
st.markdown(
    ...
    <div class="tg-sub">A living browser terrarium of autonomous little beings. Change the rules, start a world, and watch settlement, scarcity, cooperation, conflict, memory and invention emerge from simple local behavior.</div>
    <div style="margin-top:10px"><span class="tg-pill">CLICK AN AGENT</span><span class="tg-pill">DRAG TO PAN</span><span class="tg-pill">WHEEL TO ZOOM</span><span class="tg-pill">SPACE = PAUSE</span></div>
    """,
    unsafe_allow_html=True,
)
...
with st.expander("What is actually happening under the glass?"):
    st.markdown(
        """
        Every inhabitant has energy, age, a home tendency, curiosity, sociability, aggression, memory and a small relationship network. They wander toward food, water and neighbors; cooperate or fight according to local conditions; carry resources back toward camps; and occasionally transmit innovations. Dense, persistent cooperation can nucleate settlements. Scarcity and unstable climate change the resource field over time.

        This is deliberately a **toy agent-based model**, not a scientific forecast. Its useful purpose is to make emergence legible: identical rules can create very different histories from different seeds, while identical seeds reproduce the same initial world.
        """
    )
