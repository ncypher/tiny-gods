...
st.markdown("""<div class="tg-kicker">EMERGENT SYSTEMS LAB / TERRARIUM 01</div><div class="tg-title">Tiny Gods</div><div class="tg-sub">A living browser terrarium where agents become families, camps become cultures, legends become houses — and now you can descend from the god view into the settlements themselves.</div><div style="margin-top:10px"><span class="tg-pill">DOUBLE-CLICK CAMP = ENTER</span><span class="tg-pill">ESC = RETURN</span><span class="tg-pill">DRAG TO PAN</span><span class="tg-pill">WHEEL TO ZOOM</span><span class="tg-pill">SPACE = PAUSE</span></div>""",unsafe_allow_html=True)
html=(ROOT/"terrarium.html").read_text(encoding="utf-8").replace("__TINY_GODS_CONFIG__",json.dumps(config))
patches=["culture_v03.js","spectacle_v04.js","ages_v05.js","legends_v05.js","dynasties_v06.js","under_glass_v07.js"]
